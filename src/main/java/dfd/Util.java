...
*/
    ...
    public static Integer restoreInteger(byte[] input) {
        byte[] res_input = Util.revertBytes(input);
        ByteBuffer ttt = ByteBuffer.allocate(Integer.SIZE / 8).put(res_input);
        ttt.position(0);
        return ttt.getInt();
    }
    ...
    public static Short restoreShort(byte[] input) {
        byte[] res_input = Util.revertBytes(input);
        ByteBuffer ttt = ByteBuffer.allocate(Short.SIZE / 8).put(res_input);
        ttt.position(0);
        return ttt.getShort();
    }
    ...
    public static Long restoreLong(byte[] input) {
        byte[] res_input = Util.revertBytes(input);
        ByteBuffer ttt = ByteBuffer.allocate(Long.SIZE / 8).put(res_input);
        ttt.position(0);
        return ttt.getLong();
    }
    ...
    public static UnsignedLong restoreUnsignedLong(byte[] input) {
        return UnsignedLong.valueOf(Util.restoreLong(input));
    }
